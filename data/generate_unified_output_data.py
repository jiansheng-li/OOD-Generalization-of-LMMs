...
def search_pred_info(answer_by_zeroshot, class_names):
    ...
    confidence_score_match = re.search(confidence_score_pattern, text_in_zeroshot, re.DOTALL)
...
def convert_zeroshot_answer_into_unified_output(dataset, answer_file, unified_input, args, first_dataset_flag=True):
    with open(answer_file, 'r') as file:
        ...
        for line in file:
            ...
            predicted_class, confidence_score, reasoning = search_pred_info(answer_by_zeroshot, class_names)
            ...
            with open(os.path.join(args.output_dir, f'unified_output_{args.model_name}.jsonl'), mode) as jsonl_file:
